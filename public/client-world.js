...
treeTrunkImage.src = "assets/interactive_tree_trunk_damaged_v376.png?v=430";

const treeCanopyImages = [];

const treeCanopyImage = new Image();
treeCanopyImage.src = "assets/interactive_tree_canopy_v376.png?v=430";
treeCanopyImages.push(treeCanopyImage);

const treeCanopyImageVariantB = new Image();
treeCanopyImageVariantB.src = "assets/interactive_tree_canopy_v376_flip.png?v=430";
treeCanopyImages.push(treeCanopyImageVariantB);

const fireResistantTreeTrunkImage = new Image();
fireResistantTreeTrunkImage.src = "assets/fire_immune_tree_trunk_v1.png?v=430";
const fireResistantTreeCanopyImage = new Image();
fireResistantTreeCanopyImage.src = "assets/fire_immune_tree_canopy_v1.png?v=430";
const fireResistantTreeCanopyFlippedImage = new Image();
fireResistantTreeCanopyFlippedImage.src = "assets/fire_immune_tree_canopy_v1_flip.png?v=430";
...
treeDamagedTrunkImage.src = "assets/interactive_tree_trunk_v376.png?v=430";

const treeStumpImage = new Image();
treeStumpImage.src = "assets/interactive_tree_stump_v376.png?v=430";
