...
function buildClientEnemyFoundation() {
  ...
  const greenJellyCubeLootImage = loadImage("assets/green_jelly_cube.png?v=407");
  const torchLootImage = loadImage("assets/torch_v1.png?v=407");
  ...
  const woodFloorLootImage = loadImage("assets/ui/wood_floor.png?v=407");
  const woodWallLootImage = loadImage("assets/ui/wood_wall.png?v=407");
  const woodDoorLootImage = loadImage("assets/ui/wood_door.png?v=407");
