...
function buildClientEnemyFoundation() {
  ...
  const greenJellyCubeLootImage = loadImage("assets/green_jelly_cube.png?v=430");
  const torchLootImage = loadImage("assets/torch_v1.png?v=430");
  ...
  const craftTigerPawWoodIcon = document.getElementById("craftTigerPawWoodIcon");
  if (craftTigerPawWoodIcon) craftTigerPawWoodIcon.src = woodImage.src;
  const craftTigerPawStoneIcon = document.getElementById("craftTigerPawStoneIcon");
  if (craftTigerPawStoneIcon) craftTigerPawStoneIcon.src = rockLootableImage.src;
  ...
  const inventoryTigerPawImg = document.getElementById("inventoryTigerPawImg");
  if (inventoryTigerPawImg) inventoryTigerPawImg.src = tigerPawImage.src;
  ...
  const woodFloorLootImage = loadImage("assets/ui/wood_floor.png?v=430");
  const stoneFloorLootImage = loadImage("assets/ui/stone_floor.png?v=430");
  const woodWallLootImage = loadImage("assets/ui/wood_wall.png?v=430");
  const woodDoorLootImage = loadImage("assets/ui/wood_door.png?v=430");
  const chestLootImage = loadImage("assets/building/chest_closed_v414.png?v=430");
  const craftingTableLootImage = loadImage("assets/wood_bench_v2.png?v=430");
  ...
  const SPECIAL_RESOURCE_DROP_PROFILES = Object.freeze({
    ...
    chest: Object.freeze({
      image: chestLootImage,
      shadowWidth: 8
    }),
    craftingTable: Object.freeze({
      image: craftingTableLootImage,
      shadowWidth: 9,
      drawWidth: 18,
      drawHeight: 18
    })
