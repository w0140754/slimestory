...
const checks = [
  [packageJson.version === "0.6.11.361", "package version is 0.6.11.361"],
  [server.includes('const BUILD_VERSION = "6-11-361";') && read("public", "client-config.js").includes('const CLIENT_BUILD_VERSION = "6-11-361";'), "server/client build versions are 330"],
  [indexHtml.includes('/client-enemies.js?v=361') && indexHtml.includes('/client-enemy-rendering.js?v=361') && indexHtml.includes('/game.js?v=361'), "330 game cache keys"],
  [editorHtml.includes('/map-editor.js?v=361') && editor.includes('const BUILD = "361";'), "330 editor cache/build keys"],
