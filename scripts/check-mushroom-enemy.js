...
const checks = [
  [packageJson.version === "0.6.11.373", "package version is 0.6.11.373"],
  [server.includes('const BUILD_VERSION = "6-11-373";') && read("public", "client-config.js").includes('const CLIENT_BUILD_VERSION = "6-11-373";'), "server/client build versions are 330"],
  [indexHtml.includes('/client-enemies.js?v=373') && indexHtml.includes('/client-enemy-rendering.js?v=373') && indexHtml.includes('/game.js?v=373'), "330 game cache keys"],
  [editorHtml.includes('/map-editor.js?v=372') && editor.includes('const BUILD = "372";'), "330 editor cache/build keys"],
