...
const checks = [
  [packageJson.version === "0.6.11.367", "package version is 0.6.11.367"],
  [server.includes('const BUILD_VERSION = "6-11-367";') && read("public", "client-config.js").includes('const CLIENT_BUILD_VERSION = "6-11-367";'), "server/client build versions are 330"],
  [indexHtml.includes('/client-enemies.js?v=367') && indexHtml.includes('/client-enemy-rendering.js?v=367') && indexHtml.includes('/game.js?v=367'), "330 game cache keys"],
  [editorHtml.includes('/map-editor.js?v=367') && editor.includes('const BUILD = "367";'), "330 editor cache/build keys"],
