...
const checks = [
  [packageJson.version === "0.6.11.364", "package version is 0.6.11.364"],
  [server.includes('const BUILD_VERSION = "6-11-364";') && read("public", "client-config.js").includes('const CLIENT_BUILD_VERSION = "6-11-364";'), "server/client build versions are 330"],
  [indexHtml.includes('/client-enemies.js?v=364') && indexHtml.includes('/client-enemy-rendering.js?v=364') && indexHtml.includes('/game.js?v=364'), "330 game cache keys"],
  [editorHtml.includes('/map-editor.js?v=364') && editor.includes('const BUILD = "364";'), "330 editor cache/build keys"],
