...
const checks = [
  [packageJson.version === "0.6.11.374", "package version is 0.6.11.374"],
  [server.includes('const BUILD_VERSION = "6-11-374";') && read("public", "client-config.js").includes('const CLIENT_BUILD_VERSION = "6-11-374";'), "server/client build versions are 330"],
  [indexHtml.includes('/client-enemies.js?v=374') && indexHtml.includes('/client-enemy-rendering.js?v=374') && indexHtml.includes('/game.js?v=374'), "330 game cache keys"],
  [editorHtml.includes('/map-editor.js?v=374') && editor.includes('const BUILD = "374";'), "330 editor cache/build keys"],
