...
const checks = [
  [packageJson.version === "0.6.11.360", "package version is 0.6.11.360"],
  [server.includes('const BUILD_VERSION = "6-11-360";') && read("public", "client-config.js").includes('const CLIENT_BUILD_VERSION = "6-11-360";'), "server/client build versions are 330"],
  [indexHtml.includes('/client-enemies.js?v=360') && indexHtml.includes('/client-enemy-rendering.js?v=360') && indexHtml.includes('/game.js?v=360'), "330 game cache keys"],
  [editorHtml.includes('/map-editor.js?v=360') && editor.includes('const BUILD = "360";'), "330 editor cache/build keys"],
