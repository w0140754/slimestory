...
const checks = [
  [packageJson.version === "0.6.11.362", "package version is 0.6.11.362"],
  [server.includes('const BUILD_VERSION = "6-11-362";') && read("public", "client-config.js").includes('const CLIENT_BUILD_VERSION = "6-11-362";'), "server/client build versions are 330"],
  [indexHtml.includes('/client-enemies.js?v=362') && indexHtml.includes('/client-enemy-rendering.js?v=362') && indexHtml.includes('/game.js?v=362'), "330 game cache keys"],
  [editorHtml.includes('/map-editor.js?v=362') && editor.includes('const BUILD = "362";'), "330 editor cache/build keys"],
