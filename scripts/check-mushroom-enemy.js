...
const checks = [
  [packageJson.version === "0.6.11.370", "package version is 0.6.11.370"],
  [server.includes('const BUILD_VERSION = "6-11-370";') && read("public", "client-config.js").includes('const CLIENT_BUILD_VERSION = "6-11-370";'), "server/client build versions are 330"],
  [indexHtml.includes('/client-enemies.js?v=370') && indexHtml.includes('/client-enemy-rendering.js?v=370') && indexHtml.includes('/game.js?v=370'), "330 game cache keys"],
  [editorHtml.includes('/map-editor.js?v=370') && editor.includes('const BUILD = "370";'), "330 editor cache/build keys"],
