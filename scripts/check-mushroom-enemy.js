...
const checks = [
  [packageJson.version === "0.6.11.353", "package version is 0.6.11.353"],
  [server.includes('const BUILD_VERSION = "6-11-353";') && read("public", "client-config.js").includes('const CLIENT_BUILD_VERSION = "6-11-353";'), "server/client build versions are 330"],
  [indexHtml.includes('/client-enemies.js?v=353') && indexHtml.includes('/client-enemy-rendering.js?v=353') && indexHtml.includes('/game.js?v=353'), "330 game cache keys"],
  [editorHtml.includes('/map-editor.js?v=353') && editor.includes('const BUILD = "351";'), "330 editor cache/build keys"],
