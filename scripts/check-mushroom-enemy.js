...
const checks = [
  [packageJson.version === "0.6.11.363", "package version is 0.6.11.363"],
  [server.includes('const BUILD_VERSION = "6-11-363";') && read("public", "client-config.js").includes('const CLIENT_BUILD_VERSION = "6-11-363";'), "server/client build versions are 330"],
  [indexHtml.includes('/client-enemies.js?v=363') && indexHtml.includes('/client-enemy-rendering.js?v=363') && indexHtml.includes('/game.js?v=363'), "330 game cache keys"],
  [editorHtml.includes('/map-editor.js?v=363') && editor.includes('const BUILD = "363";'), "330 editor cache/build keys"],
