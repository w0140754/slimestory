...
const checks = [
  [packageJson.version === "0.6.11.359", "package version is 0.6.11.359"],
  [server.includes('const BUILD_VERSION = "6-11-359";') && read("public", "client-config.js").includes('const CLIENT_BUILD_VERSION = "6-11-359";'), "server/client build versions are 330"],
  [indexHtml.includes('/client-enemies.js?v=359') && indexHtml.includes('/client-enemy-rendering.js?v=359') && indexHtml.includes('/game.js?v=359'), "330 game cache keys"],
  [editorHtml.includes('/map-editor.js?v=359') && editor.includes('const BUILD = "359";'), "330 editor cache/build keys"],
