...
const checks = [
  [packageJson.version === "0.6.11.372", "package version is 0.6.11.372"],
  [server.includes('const BUILD_VERSION = "6-11-372";') && read("public", "client-config.js").includes('const CLIENT_BUILD_VERSION = "6-11-372";'), "server/client build versions are 330"],
  [indexHtml.includes('/client-enemies.js?v=372') && indexHtml.includes('/client-enemy-rendering.js?v=372') && indexHtml.includes('/game.js?v=372'), "330 game cache keys"],
