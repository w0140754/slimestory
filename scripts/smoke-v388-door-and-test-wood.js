...
(async () => {
  try {
    ...
    if (first.welcome.buildVersion !== "6-11-390") throw new Error(`unexpected build ${first.welcome.buildVersion}`);
    ...
    if (observer.welcome.buildVersion !== "6-11-390") throw new Error(`unexpected observer build ${observer.welcome.buildVersion}`);
