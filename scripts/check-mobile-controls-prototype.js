...
assert(server.includes('const BUILD_VERSION = "6-11-364";'), "server build must be v350");
assert(config.includes('const CLIENT_BUILD_VERSION = "6-11-364";'), "client build must be v350");
assert(pkg.version === "0.6.11.364", "package version must be v350");
...
assert(html.includes('/client-input.js?v=364') && html.includes('/client-app.js?v=364'), "v350 cache keys missing");
