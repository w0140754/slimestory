...
assert(server.includes('const BUILD_VERSION = "6-11-358";'), "server build must be v350");
assert(config.includes('const CLIENT_BUILD_VERSION = "6-11-358";'), "client build must be v350");
assert(pkg.version === "0.6.11.358", "package version must be v350");
...
assert(html.includes('/client-input.js?v=358') && html.includes('/client-app.js?v=358'), "v350 cache keys missing");
