...
assert(html.includes('/shared/combat-balance.js?v=353') && html.includes('/client-enemies.js?v=353') && html.includes('/client-enemy-rendering.js?v=353') && html.includes('/game.js?v=353'), 'current enemy/game/combat cache keys missing');
