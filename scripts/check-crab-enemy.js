...
assert(html.includes('/shared/combat-balance.js?v=355') && html.includes('/client-enemies.js?v=355') && html.includes('/client-enemy-rendering.js?v=355') && html.includes('/game.js?v=355'), 'current enemy/game/combat cache keys missing');
