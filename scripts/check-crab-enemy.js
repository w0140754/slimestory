...
assert(html.includes('/shared/combat-balance.js?v=375') && html.includes('/client-enemies.js?v=375') && html.includes('/client-enemy-rendering.js?v=375') && html.includes('/game.js?v=375'), 'current enemy/game/combat cache keys missing');
