...
assert(html.includes('/shared/combat-balance.js?v=370') && html.includes('/client-enemies.js?v=370') && html.includes('/client-enemy-rendering.js?v=370') && html.includes('/game.js?v=370'), 'current enemy/game/combat cache keys missing');
