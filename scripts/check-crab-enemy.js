...
assert(html.includes('/shared/combat-balance.js?v=354') && html.includes('/client-enemies.js?v=354') && html.includes('/client-enemy-rendering.js?v=354') && html.includes('/game.js?v=354'), 'current enemy/game/combat cache keys missing');
