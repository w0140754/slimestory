...
assert(html.includes('/shared/combat-balance.js?v=373') && html.includes('/client-enemies.js?v=373') && html.includes('/client-enemy-rendering.js?v=373') && html.includes('/game.js?v=373'), 'current enemy/game/combat cache keys missing');
