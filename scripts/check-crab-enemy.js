...
assert(html.includes('/shared/combat-balance.js?v=367') && html.includes('/client-enemies.js?v=367') && html.includes('/client-enemy-rendering.js?v=367') && html.includes('/game.js?v=367'), 'current enemy/game/combat cache keys missing');
