...
assert(html.includes('/shared/combat-balance.js?v=362') && html.includes('/client-enemies.js?v=362') && html.includes('/client-enemy-rendering.js?v=362') && html.includes('/game.js?v=362'), 'current enemy/game/combat cache keys missing');
