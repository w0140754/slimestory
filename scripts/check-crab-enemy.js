...
assert(html.includes('/shared/combat-balance.js?v=374') && html.includes('/client-enemies.js?v=374') && html.includes('/client-enemy-rendering.js?v=374') && html.includes('/game.js?v=374'), 'current enemy/game/combat cache keys missing');
