...
assert(html.includes('/shared/combat-balance.js?v=380') && html.includes('/client-enemies.js?v=380') && html.includes('/client-enemy-rendering.js?v=380') && html.includes('/game.js?v=380'), 'current enemy/game/combat cache keys missing');
