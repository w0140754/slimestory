...
assert(enemies.includes('mushroom_sleep_v1.png?v=336'), 'sleep mushroom asset must use v331 retry key');
assert(enemies.includes('mushroom_awake_v1.png?v=336'), 'awake mushroom asset must use v331 retry key');
assert(enemies.includes('mushroom_flash_v1.png?v=336'), 'flash mushroom asset must use v331 retry key');
...
assert(index.includes('/client-enemy-rendering.js?v=336') && index.includes('/client-enemies.js?v=336'), 'client cache keys must be v332');
