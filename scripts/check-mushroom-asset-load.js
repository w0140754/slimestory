...
assert(enemies.includes('mushroom_sleep_v1.png?v=337'), 'sleep mushroom asset must use v331 retry key');
assert(enemies.includes('mushroom_awake_v1.png?v=337'), 'awake mushroom asset must use v331 retry key');
assert(enemies.includes('mushroom_flash_v1.png?v=337'), 'flash mushroom asset must use v331 retry key');
...
assert(index.includes('/client-enemy-rendering.js?v=337') && index.includes('/client-enemies.js?v=337'), 'client cache keys must be v332');
