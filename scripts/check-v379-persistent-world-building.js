...
assert.strictEqual(pkg.version, "0.6.11.394", "package must remain on current v380 build");
...
assert(game.includes('const BUILD_HOTBAR_ITEMS = Object.freeze(["woodFloor", "woodWall", "woodDoor"]);'), "building pieces must remain hotbar-assignable");
...
assert(network.includes("requestStructurePlacement(kind, x, y, edge = null)"), "network placement request missing");
