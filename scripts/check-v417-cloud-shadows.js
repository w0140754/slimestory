...
assert(clientConfig.includes('CLIENT_BUILD_VERSION = "6-11-419"'), "client build version not bumped");
assert(server.includes('BUILD_VERSION = "6-11-419"'), "server build version not bumped");
