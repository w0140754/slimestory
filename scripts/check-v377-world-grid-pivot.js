...
assert(server.includes('const BUILD_VERSION = "6-11-413";'), "server build marker must be v377");
assert(read("public", "client-config.js").includes('const CLIENT_BUILD_VERSION = "6-11-413";'), "client build marker must be v377");
