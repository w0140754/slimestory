...
assert(config.includes('const CLIENT_BUILD_VERSION = "6-11-370";'), "client build must be v344");
assert(index.includes('/client-app.js?v=370') && index.includes('/client-terrain.js?v=370'), "v344 terrain/app cache keys missing");
