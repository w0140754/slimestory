...
assert(config.includes('const CLIENT_BUILD_VERSION = "6-11-361";'), "client build must be v344");
assert(index.includes('/client-app.js?v=361') && index.includes('/client-terrain.js?v=361'), "v344 terrain/app cache keys missing");
