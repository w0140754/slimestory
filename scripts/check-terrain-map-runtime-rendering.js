...
assert(config.includes('const CLIENT_BUILD_VERSION = "6-11-352";'), "client build must be v344");
assert(index.includes('/client-app.js?v=352') && index.includes('/client-terrain.js?v=352'), "v344 terrain/app cache keys missing");
