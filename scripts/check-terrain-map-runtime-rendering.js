...
assert(config.includes('const CLIENT_BUILD_VERSION = "6-11-367";'), "client build must be v344");
assert(index.includes('/client-app.js?v=367') && index.includes('/client-terrain.js?v=367'), "v344 terrain/app cache keys missing");
