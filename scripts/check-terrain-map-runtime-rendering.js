...
assert(config.includes('const CLIENT_BUILD_VERSION = "6-11-369";'), "client build must be v344");
assert(index.includes('/client-app.js?v=369') && index.includes('/client-terrain.js?v=369'), "v344 terrain/app cache keys missing");
