...
assert(config.includes('const CLIENT_BUILD_VERSION = "6-11-359";'), "client build must be v344");
assert(index.includes('/client-app.js?v=359') && index.includes('/client-terrain.js?v=359'), "v344 terrain/app cache keys missing");
