...
assert(world.includes('assets/interactive_tree_trunk_damaged_v376.png?v=431'), 'interactive tree damaged trunk cache key missing');
assert(world.includes('assets/interactive_tree_stump_v376.png?v=431'), 'interactive tree stump cache key missing');
