...
assert(html.includes('/client-input.js?v=364') && html.includes('/client-app.js?v=364'));
...
assert(input.includes('weapon !== "bow",\n    weapon === "bow"'), "melee AUTO must require actual hit range and Bow must require visibility");
assert(input.includes('MOBILE_BOW_VISIBLE_TARGET_DISTANCE = 320'), "Bow projectile-distance cap missing");
...
assert.strictEqual(adopted.version, 56, "mobile combat changes must preserve current authored world data");
