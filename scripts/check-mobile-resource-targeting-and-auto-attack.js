...
assert(html.includes('/client-input.js?v=358') && html.includes('/client-app.js?v=358'));
...
assert.strictEqual(adopted.version, 53, "mobile combat changes must not alter authored world data");
