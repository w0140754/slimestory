...
assert(html.includes('/client-input.js?v=360') && html.includes('/client-app.js?v=360'));
...
assert.strictEqual(adopted.version, 55, "mobile combat changes must preserve current authored world data");
