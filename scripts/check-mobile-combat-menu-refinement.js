...
assert(server.includes('const BUILD_VERSION = "6-11-367";'), "server build must be v351");
assert(config.includes('const CLIENT_BUILD_VERSION = "6-11-367";'), "client build must be v351");
assert(pkg.version === "0.6.11.367", "package version must be v351");
...
assert(html.includes('/client-input.js?v=367') && html.includes('/client-app.js?v=367'), "v351 client cache keys missing");
