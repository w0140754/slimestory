...
assert(server.includes('const BUILD_VERSION = "6-11-370";'), "server build must be v351");
assert(config.includes('const CLIENT_BUILD_VERSION = "6-11-370";'), "client build must be v351");
assert(pkg.version === "0.6.11.370", "package version must be v351");
...
assert(html.includes('/client-input.js?v=370') && html.includes('/client-app.js?v=370'), "v351 client cache keys missing");
