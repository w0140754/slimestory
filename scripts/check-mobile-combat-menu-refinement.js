...
assert(server.includes('const BUILD_VERSION = "6-11-374";'), "server build must be v351");
assert(config.includes('const CLIENT_BUILD_VERSION = "6-11-374";'), "client build must be v351");
assert(pkg.version === "0.6.11.374", "package version must be v351");
...
assert(html.includes('/client-input.js?v=374') && html.includes('/client-app.js?v=374'), "v351 client cache keys missing");
