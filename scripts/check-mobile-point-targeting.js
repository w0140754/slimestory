...
assert(server.includes('const BUILD_VERSION = "6-11-393";'), "server build must be v355");
assert(config.includes('const CLIENT_BUILD_VERSION = "6-11-393";'), "client build must be v355");
assert.strictEqual(pkg.version, "0.6.11.393", "package version must be v355");
assert(html.includes('/client-input.js?v=393') && html.includes('/client-magus-abilities.js?v=393'), "v355 cache keys missing");
