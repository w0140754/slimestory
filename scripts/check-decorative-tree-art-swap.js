...
assert(world.includes('fire_immune_tree_trunk_v1.png?v=394'), 'decorative tree trunk cache key missing');
assert(world.includes('fire_immune_tree_canopy_v1.png?v=394'), 'decorative tree canopy cache key missing');
assert(world.includes('fire_immune_tree_canopy_v1_flip.png?v=394'), 'decorative tree flipped canopy cache key missing');
