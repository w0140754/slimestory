...
(async () => {
  try {
    ...
    if (actor.welcome.buildVersion !== "6-11-432" || actor.welcome.worldSeed !== 0) throw new Error("unexpected actor welcome");
    if (observer.welcome.buildVersion !== "6-11-432") throw new Error("unexpected observer welcome");
