...
assert(config.includes('const CLIENT_BUILD_VERSION = "6-11-369";'), "client build must be 6-11-369");
...
assert(game.includes('sapgemWandImage = loadImage("assets/sapgem_wand_v4.png?v=369")'), "current redrawn Sapgem sprite not wired");
