...
assert(pkg.version === "0.6.11.361", "package version must be 0.6.11.361");
assert(html.includes('/shared/combat-balance.js?v=361') && html.includes('/game.js?v=361'), "v336 cache keys missing");
