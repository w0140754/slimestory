...
assert.strictEqual(adopted.version, 68, "mobile camera zoom must preserve current authored world data");
...
assert(html.includes('/game.js?v=367') && html.includes('/client-app.js?v=367'));
