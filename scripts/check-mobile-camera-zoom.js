...
assert.strictEqual(adopted.version, 53, "mobile camera zoom must not alter authored world data");
...
assert(html.includes('/game.js?v=358') && html.includes('/client-app.js?v=358'));
