...
assert(server.includes('const BUILD_VERSION = "6-11-432";'), "server build must be v377");
assert(config.includes('const CLIENT_BUILD_VERSION = "6-11-432";'), "client build must be v377");
assert.strictEqual(pkg.version, "0.6.11.432", "package version must be v377");
