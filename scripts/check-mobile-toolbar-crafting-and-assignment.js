...
assert(server.includes('const BUILD_VERSION = "6-11-391";'), "server build must be v377");
assert(config.includes('const CLIENT_BUILD_VERSION = "6-11-391";'), "client build must be v377");
assert.strictEqual(pkg.version, "0.6.11.391", "package version must be v377");
assert(html.includes('/game.js?v=391') && html.includes('/client-input.js?v=391'), "v377 cache keys missing");
