...
assert(server.includes('const BUILD_VERSION = "6-11-369";'), "server build must be v353");
assert(config.includes('const CLIENT_BUILD_VERSION = "6-11-369";'), "client build must be v353");
assert.strictEqual(pkg.version, "0.6.11.369", "package version must be v353");
assert(html.includes('/game.js?v=369') && html.includes('/client-input.js?v=369'), "v353 cache keys missing");
