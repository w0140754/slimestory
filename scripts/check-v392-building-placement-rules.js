...
assert(server.includes('BUILD_WALL_KINDS.has(structure?.kind)')); 
...
assert(game.includes('if (["woodDoor", "caveDoor"].includes(kind) && !doorCandidateHasFlankingWalls(candidate)) return null;'));
