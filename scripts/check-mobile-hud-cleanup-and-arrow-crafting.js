...
assert(html.includes('/game.js?v=366') && html.includes('/client-app.js?v=366'));
...
assert.strictEqual(adopted.version, 59, "HUD cleanup must preserve current authored map data");
