...
assert(html.includes('/game.js?v=361') && html.includes('/client-app.js?v=361'));
...
assert.strictEqual(adopted.version, 55, "HUD cleanup must preserve authored map revision 55");
