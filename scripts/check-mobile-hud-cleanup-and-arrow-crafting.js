...
assert(html.includes('/game.js?v=365') && html.includes('/client-app.js?v=365'));
...
assert.strictEqual(adopted.version, 58, "HUD cleanup must preserve authored map revision 58");
