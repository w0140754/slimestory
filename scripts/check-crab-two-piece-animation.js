...
assert(html.includes('/client-enemies.js?v=413') && html.includes('/client-enemy-rendering.js?v=413') && html.includes('/game.js?v=413'), 'current Crab cache keys missing');
