...
assert(html.includes('/client-enemies.js?v=352') && html.includes('/client-enemy-rendering.js?v=352') && html.includes('/game.js?v=352'), 'current Crab cache keys missing');
