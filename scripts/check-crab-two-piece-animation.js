...
assert(html.includes('/client-enemies.js?v=430') && html.includes('/client-enemy-rendering.js?v=430') && html.includes('/game.js?v=430'), 'current Crab cache keys missing');
