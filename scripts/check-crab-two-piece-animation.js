...
assert(html.includes('/client-enemies.js?v=427') && html.includes('/client-enemy-rendering.js?v=427') && html.includes('/game.js?v=427'), 'current Crab cache keys missing');
