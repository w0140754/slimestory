...
assert(html.includes('/client-enemies.js?v=367') && html.includes('/client-enemy-rendering.js?v=367') && html.includes('/game.js?v=367'), 'current Crab cache keys missing');
