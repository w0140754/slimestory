...
assert(html.includes('/client-enemies.js?v=370') && html.includes('/client-enemy-rendering.js?v=370') && html.includes('/game.js?v=370'), 'current Crab cache keys missing');
