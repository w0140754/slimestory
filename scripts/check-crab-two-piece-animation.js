...
assert(html.includes('/client-enemies.js?v=354') && html.includes('/client-enemy-rendering.js?v=354') && html.includes('/game.js?v=354'), 'current Crab cache keys missing');
