...
assert(html.includes('/client-enemies.js?v=429') && html.includes('/client-enemy-rendering.js?v=429') && html.includes('/game.js?v=429'), 'current Crab cache keys missing');
