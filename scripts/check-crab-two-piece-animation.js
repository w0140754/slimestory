...
assert(html.includes('/client-enemies.js?v=406') && html.includes('/client-enemy-rendering.js?v=406') && html.includes('/game.js?v=406'), 'current Crab cache keys missing');
