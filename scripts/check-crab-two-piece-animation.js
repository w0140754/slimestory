...
assert(html.includes('/client-enemies.js?v=366') && html.includes('/client-enemy-rendering.js?v=366') && html.includes('/game.js?v=366'), 'current Crab cache keys missing');
