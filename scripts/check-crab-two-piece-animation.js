...
assert(html.includes('/client-enemies.js?v=394') && html.includes('/client-enemy-rendering.js?v=394') && html.includes('/game.js?v=394'), 'current Crab cache keys missing');
