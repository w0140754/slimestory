...
assert(html.includes('/client-enemies.js?v=410') && html.includes('/client-enemy-rendering.js?v=410') && html.includes('/game.js?v=410'), 'current Crab cache keys missing');
