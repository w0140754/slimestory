...
assert(html.includes('/client-enemies.js?v=364') && html.includes('/client-enemy-rendering.js?v=364') && html.includes('/game.js?v=364'), 'current Crab cache keys missing');
