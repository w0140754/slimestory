...
assert(html.includes('/client-enemies.js?v=351') && html.includes('/client-enemy-rendering.js?v=351') && html.includes('/game.js?v=351'), 'current Crab cache keys missing');
