...
assert(html.includes('/client-enemies.js?v=374') && html.includes('/client-enemy-rendering.js?v=374') && html.includes('/game.js?v=374'), 'current Crab cache keys missing');
