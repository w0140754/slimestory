...
assert(html.includes('/client-enemies.js?v=369') && html.includes('/client-enemy-rendering.js?v=369') && html.includes('/game.js?v=369'), 'current Crab cache keys missing');
