...
assert(html.includes('/client-enemies.js?v=365') && html.includes('/client-enemy-rendering.js?v=365') && html.includes('/game.js?v=365'), 'current Crab cache keys missing');
