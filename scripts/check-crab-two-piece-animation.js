...
assert(html.includes('/client-enemies.js?v=353') && html.includes('/client-enemy-rendering.js?v=353') && html.includes('/game.js?v=353'), 'current Crab cache keys missing');
