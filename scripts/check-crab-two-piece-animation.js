...
assert(html.includes('/client-enemies.js?v=359') && html.includes('/client-enemy-rendering.js?v=359') && html.includes('/game.js?v=359'), 'current Crab cache keys missing');
