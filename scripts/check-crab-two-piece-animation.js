...
assert(html.includes('/client-enemies.js?v=391') && html.includes('/client-enemy-rendering.js?v=391') && html.includes('/game.js?v=391'), 'current Crab cache keys missing');
