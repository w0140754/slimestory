...
assert(html.includes('/client-enemies.js?v=407') && html.includes('/client-enemy-rendering.js?v=407') && html.includes('/game.js?v=407'), 'current Crab cache keys missing');
