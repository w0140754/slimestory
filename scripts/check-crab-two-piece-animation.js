...
assert(html.includes('/client-enemies.js?v=372') && html.includes('/client-enemy-rendering.js?v=372') && html.includes('/game.js?v=372'), 'current Crab cache keys missing');
