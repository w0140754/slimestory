...
assert(html.includes('/client-enemies.js?v=360') && html.includes('/client-enemy-rendering.js?v=360') && html.includes('/game.js?v=360'), 'current Crab cache keys missing');
