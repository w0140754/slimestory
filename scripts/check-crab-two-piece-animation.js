...
assert(html.includes('/client-enemies.js?v=373') && html.includes('/client-enemy-rendering.js?v=373') && html.includes('/game.js?v=373'), 'current Crab cache keys missing');
