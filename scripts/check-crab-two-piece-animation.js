...
assert(html.includes('/client-enemies.js?v=350') && html.includes('/client-enemy-rendering.js?v=350') && html.includes('/game.js?v=350'), 'current Crab cache keys missing');
