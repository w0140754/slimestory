...
assert(html.includes('/client-enemies.js?v=393') && html.includes('/client-enemy-rendering.js?v=393') && html.includes('/game.js?v=393'), 'current Crab cache keys missing');
