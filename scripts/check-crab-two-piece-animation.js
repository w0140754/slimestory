...
assert(html.includes('/client-enemies.js?v=361') && html.includes('/client-enemy-rendering.js?v=361') && html.includes('/game.js?v=361'), 'current Crab cache keys missing');
