...
assert(html.includes('/client-enemies.js?v=390') && html.includes('/client-enemy-rendering.js?v=390') && html.includes('/game.js?v=390'), 'current Crab cache keys missing');
