...
assert(html.includes('/client-enemies.js?v=428') && html.includes('/client-enemy-rendering.js?v=428') && html.includes('/game.js?v=428'), 'current Crab cache keys missing');
