...
assert(game.includes('chestClosedStructureImage = loadImage("assets/building/chest_closed_v414.png?v=429")'));
assert(game.includes('chestOpenStructureImage = loadImage("assets/building/chest_open_v414.png?v=429")'));
