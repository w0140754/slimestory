...
assert.strictEqual(pkg.version, "0.6.11.424", "package version must be v378");
assert(server.includes('const BUILD_VERSION = "6-11-424";'), "server build marker must be v378");
assert(read("public", "client-config.js").includes('const CLIENT_BUILD_VERSION = "6-11-424";'), "client build marker must be v378");
