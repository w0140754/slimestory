...
assert(html.includes('/client-app.js?v=380') && html.includes('/game.js?v=380'));
...
assert.ok(adopted.version >= 68, "pixel scaling must preserve current authored map data");
