...
assert(server.includes('const BUILD_VERSION = "6-11-471";'), 'server build must be v347');
assert(config.includes('const CLIENT_BUILD_VERSION = "6-11-471";'), 'client build must be v347');
