...
assert(html.includes('/shared/combat-balance.js?v=394'), 'combat balance cache key must be v27');
assert(html.includes('/client-enemies.js?v=394') && html.includes('/game.js?v=394'), 'v347 client cache keys missing');
