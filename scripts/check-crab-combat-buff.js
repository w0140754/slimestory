...
assert(html.includes('/shared/combat-balance.js?v=366'), 'combat balance cache key must be v27');
assert(html.includes('/client-enemies.js?v=366') && html.includes('/game.js?v=366'), 'v347 client cache keys missing');
