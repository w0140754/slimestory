...
assert(html.includes('/shared/combat-balance.js?v=368'), 'combat balance cache key must be v27');
assert(html.includes('/client-enemies.js?v=368') && html.includes('/game.js?v=368'), 'v347 client cache keys missing');
