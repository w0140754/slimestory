...
assert(html.includes('/shared/combat-balance.js?v=406'), 'combat balance cache key must be v27');
assert(html.includes('/client-enemies.js?v=406') && html.includes('/game.js?v=406'), 'v347 client cache keys missing');
