...
assert(html.includes('/shared/combat-balance.js?v=367'), 'combat balance cache key must be v27');
assert(html.includes('/client-enemies.js?v=367') && html.includes('/game.js?v=367'), 'v347 client cache keys missing');
