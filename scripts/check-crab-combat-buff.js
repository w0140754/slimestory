...
assert(html.includes('/shared/combat-balance.js?v=390'), 'combat balance cache key must be v27');
assert(html.includes('/client-enemies.js?v=390') && html.includes('/game.js?v=390'), 'v347 client cache keys missing');
