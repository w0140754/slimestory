...
assert(config.includes('const CLIENT_BUILD_VERSION = "6-11-393";'), 'client build must be 6-11-393');
assert(pkg.version === '0.6.11.393', 'package version must be 0.6.11.393');
assert(html.includes('/shared/combat-balance.js?v=393') && html.includes('/client-combat.js?v=393') && html.includes('/game.js?v=393'), 'v333 combat cache keys missing');
