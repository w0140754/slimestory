...
assert(server.includes('const BUILD_VERSION = "6-11-375";'), 'server build must be 6-11-375');
assert(config.includes('const CLIENT_BUILD_VERSION = "6-11-375";'), 'client build must be 6-11-375');
assert(pkg.version === '0.6.11.375', 'package version must be 0.6.11.375');
assert(html.includes('/shared/combat-balance.js?v=375') && html.includes('/client-combat.js?v=375') && html.includes('/game.js?v=375'), 'v333 combat cache keys missing');
