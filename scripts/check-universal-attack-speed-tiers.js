...
assert(config.includes('const CLIENT_BUILD_VERSION = "6-11-394";'), 'client build must be 6-11-394');
assert(pkg.version === '0.6.11.394', 'package version must be 0.6.11.394');
assert(html.includes('/shared/combat-balance.js?v=394') && html.includes('/client-combat.js?v=394') && html.includes('/game.js?v=394'), 'v333 combat cache keys missing');
