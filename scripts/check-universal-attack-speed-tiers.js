...
assert(html.includes('/shared/combat-balance.js?v=25') && html.includes('/client-combat.js?v=336') && html.includes('/game.js?v=336'), 'v333 combat cache keys missing');

assert(balance.version === 25, 'combat balance version must be 25');
