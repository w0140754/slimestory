...
assert(config.includes('const CLIENT_BUILD_VERSION = "6-11-391";'), 'client build must be 6-11-391');
assert(pkg.version === '0.6.11.391', 'package version must be 0.6.11.391');
assert(html.includes('/shared/combat-balance.js?v=391') && html.includes('/client-combat.js?v=391') && html.includes('/game.js?v=391'), 'v333 combat cache keys missing');
