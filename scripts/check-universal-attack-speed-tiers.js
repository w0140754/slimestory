...
assert(config.includes('const CLIENT_BUILD_VERSION = "6-11-380";'), 'client build must be 6-11-380');
assert(pkg.version === '0.6.11.380', 'package version must be 0.6.11.380');
assert(html.includes('/shared/combat-balance.js?v=380') && html.includes('/client-combat.js?v=380') && html.includes('/game.js?v=380'), 'v333 combat cache keys missing');

assert(balance.version === 29, 'combat balance version must be 29');
