...
assert(html.includes('/shared/combat-balance.js?v=369') && html.includes('/client-combat.js?v=369') && html.includes('/game.js?v=369'), 'v333 combat cache keys missing');

assert(balance.version === 28, 'combat balance version must be 28');
