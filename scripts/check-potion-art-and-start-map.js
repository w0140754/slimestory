...
assert(server.includes('const BUILD_VERSION = "6-11-353";'), "server build is not 6-11-353");
assert(read("public", "client-config.js").includes('const CLIENT_BUILD_VERSION = "6-11-353";'), "client build is not 6-11-353");
assert(pkg.version === "0.6.11.353", "package version is not 0.6.11.353");
