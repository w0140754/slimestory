...
assert(server.includes('const BUILD_VERSION = "6-11-336";'), "server build is not 6-11-336");
assert(read("public", "client-config.js").includes('const CLIENT_BUILD_VERSION = "6-11-336";'), "client build is not 6-11-336");
assert(pkg.version === "0.6.11.336", "package version is not 0.6.11.336");
...
assert(enemies.includes('attackPotionImage.src = "assets/attack_potion_v2.png?v=336"'), "attack potion does not use supplied sprite");
assert(enemies.includes('magicPotionImage.src = "assets/magic_potion_v2.png?v=336"'), "magic potion does not use supplied sprite");
