...
assert(server.includes('const BUILD_VERSION = "6-11-366";'), "server build is not 6-11-366");
assert(read("public", "client-config.js").includes('const CLIENT_BUILD_VERSION = "6-11-366";'), "client build is not 6-11-366");
assert(pkg.version === "0.6.11.366", "package version is not 0.6.11.366");
