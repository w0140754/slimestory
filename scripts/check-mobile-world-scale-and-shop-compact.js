...
assert(server.includes('const BUILD_VERSION = "6-11-353";'), "server build must be v352");
assert(config.includes('const CLIENT_BUILD_VERSION = "6-11-353";'), "client build must be v352");
assert(pkg.version === "0.6.11.353", "package version must be v352");
assert(html.includes('mobileCanvas.width = 256;') && html.includes('mobileCanvas.height = 144;'), "mobile logical world viewport must be 256x144");
