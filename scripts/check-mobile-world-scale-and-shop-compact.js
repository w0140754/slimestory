...
assert(server.includes('const BUILD_VERSION = "6-11-369";'), "server build must be v352");
assert(config.includes('const CLIENT_BUILD_VERSION = "6-11-369";'), "client build must be v352");
assert(pkg.version === "0.6.11.369", "package version must be v352");
