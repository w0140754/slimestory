...
assert(server.includes('const BUILD_VERSION = "6-11-358";'), "server build must be v352");
assert(config.includes('const CLIENT_BUILD_VERSION = "6-11-358";'), "client build must be v352");
assert(pkg.version === "0.6.11.358", "package version must be v352");
assert(html.includes('mobileCanvas.width = 224;') && html.includes('mobileCanvas.height = 126;'), "mobile logical world viewport must be 224x126");
