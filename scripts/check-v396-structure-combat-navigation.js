...
assert(html.includes('assets/ui/wood_floor.png?v=427'));
assert(html.includes('assets/ui/wood_wall.png?v=427'));
assert(html.includes('assets/ui/wood_door.png?v=427'));
assert(enemies.includes('assets/ui/wood_floor.png?v=427'));
