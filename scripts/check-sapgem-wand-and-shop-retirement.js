...
assert(server.includes('const BUILD_VERSION = "6-11-394";'), "server build must be 6-11-394");
assert(read("public", "client-config.js").includes('const CLIENT_BUILD_VERSION = "6-11-394";'), "client build must be 6-11-394");
assert(pkg.version === "0.6.11.394", "package version must be 0.6.11.394");
assert(html.includes('/shared/combat-balance.js?v=394') && html.includes('/game.js?v=394'), "v336 cache keys missing");
