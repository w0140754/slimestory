...
assert(server.includes('const BUILD_VERSION = "6-11-390";'), "server build must be 6-11-390");
assert(read("public", "client-config.js").includes('const CLIENT_BUILD_VERSION = "6-11-390";'), "client build must be 6-11-390");
assert(pkg.version === "0.6.11.390", "package version must be 0.6.11.390");
assert(html.includes('/shared/combat-balance.js?v=390') && html.includes('/game.js?v=390'), "v336 cache keys missing");
