...
assert(read("public", "client-config.js").includes('const CLIENT_BUILD_VERSION = "6-11-367";'), "client build must be 6-11-367");
...
assert(game.includes('sapgemWandImage = loadImage("assets/sapgem_wand_v4.png?v=367")'), "current Sapgem asset is not loaded");
