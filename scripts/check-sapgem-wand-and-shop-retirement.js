...
assert(read("public", "client-config.js").includes('const CLIENT_BUILD_VERSION = "6-11-336";'), "client build must be 6-11-336");
...
assert(game.includes('sapgemWandImage = loadImage("assets/sapgem_wand_v3.png?v=336")'), "Sapgem asset is not loaded with v336 key");
