...
const checks = [
  ...
  [server.includes('woodRing: Object.freeze({ ingredients: Object.freeze({ wood: 5 }) })') && game.includes('itemId: "charm_woodRing"') && game.includes('ingredients: Object.freeze({ wood: 5 })'), "wood ring recipe"],
  ...
  [game.includes('CONSUMABLE_ITEM_IDS = Object.freeze(["healingPotion", "attackPotion", "magicPotion"])'), "consumable item mapping"],
