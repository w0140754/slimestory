...
assert(server.includes('if (!["wood", "stone", "flower", "goldSlimeBubble", "greenJellyCube", "icedCoffee", "woodFloor", "woodWall", "woodDoor", "torch"].includes(kind))'), "Wood Door must be valid shared reclaim loot");
