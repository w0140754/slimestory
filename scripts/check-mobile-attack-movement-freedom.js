...
assert(html.includes('/client-combat.js?v=359') && html.includes('/client-app.js?v=359'));

assert(config.includes('mobileBaseSpeedMultiplier: 0.92'), "8% mobile movement adjustment missing");
...
assert.strictEqual(adopted.version, 54, "movement tuning must preserve the newest authored world data");
assert(adopted.maps.waterfallGrove, "Waterfall Grove must be preserved");

console.log("Mobile attacks allow movement with an 8% mobile-only base-speed adjustment; desktop planting remains.");
