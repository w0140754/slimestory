...
assert(html.includes('/client-combat.js?v=365') && html.includes('/client-app.js?v=365'));
...
assert.strictEqual(adopted.version, 58, "movement tuning must preserve the newest authored world data");
