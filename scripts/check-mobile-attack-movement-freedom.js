...
assert(html.includes('/client-combat.js?v=368') && html.includes('/client-app.js?v=368'));
...
assert.strictEqual(adopted.version, 68, "movement tuning must preserve the newest authored world data");
