...
assert(server.includes('const BUILD_VERSION = "6-11-431";'), "server build must be v355");
assert(config.includes('const CLIENT_BUILD_VERSION = "6-11-431";'), "client build must be v355");
assert.strictEqual(pkg.version, "0.6.11.431", "package version must be v355");
